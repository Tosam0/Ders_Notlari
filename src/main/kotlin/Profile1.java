class Profile {//D:\Videolar\Ders24  Kotlin Singleton & Object
    /**
     * Singleton olması için javada yapılması gerekenler
     * 1-Şart class'ın nesnesi dışarıdan oluşturulamasın ki dışarda memoride tek birtane bu class'ın
     * sesnesi olduğunu alıyayım.Şartı sağlamak için o class'ın defoult constract'ırını private 'de
     * tutup public'dede başka hiç bir contr'ır olmasına izin vermiyoruz.
     * <p>
     * 2-Şart Kesin olarak bir nesne oluşturmam gerekiyor. sonra geri dön(retrun)
     * <p>
     * 3-Şart dışarıdan erişilmesi için static yaptık.
     */
    ...
    public void setCounter(int increasedVolue) {
        counter += increasedVolue;
    }
}
...
class Profile1 {
    private volatile static Profile1 profile;   // 6. adim --> 5. adimdaki fonksiyonu static yapabilmek icin bu nesneyi de static yapmamiz gerekiyor.
    ...
    public synchronized static Profile1 newInstance() {      // 4. adim  --> static keyword'u verdik,
